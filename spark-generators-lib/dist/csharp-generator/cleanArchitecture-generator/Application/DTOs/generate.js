...
function generateBaseDTO(model) {
...
function generateRequestDTO(model, cls, relations) {
    return expandToStringWithNL `
...
function generateResponseDTO(model, cls, relations) {
    return expandToStringWithNL `
using ${model.configuration?.name}.Application.DTOs.Common;
using ${model.configuration?.name}.Domain.Enums;
...
function generateRelationsResponse(cls, relations) {
...
function generateRelationRequest(cls, { tgt, card, owner }) {
    switch (card) {
        case "OneToOne":
            if (owner) {
                return expandToString `
...
function generateApiResponse(model) {
    return expandToString `
...
function generateResponseBase(model) {
    return expandToString `
﻿namespace ${model.configuration?.name}.Application.DTOs.Common
{
