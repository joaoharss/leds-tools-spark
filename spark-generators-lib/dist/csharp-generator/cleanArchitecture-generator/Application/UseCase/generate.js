...
function generateBaseCase(model, target_folder) {
...
function BaseCreateHandler(model) {
...
function BaseDeleteHandler(model) {
    return expandToString `
﻿using AutoMapper;
using ${model.configuration?.name}.Application.DTOs.Common;
using ${model.configuration?.name}.Application.Interfaces;
...
function BaseUpdateHandler(model) {
    return expandToString `
﻿using AutoMapper;
using ${model.configuration?.name}.Application.DTOs.Common;
using ${model.configuration?.name}.Application.Interfaces;
...
function BaseGetAllHandler(model) {
    return expandToString `
using ${model.configuration?.name}.Application.DTOs.Common;
using ${model.configuration?.name}.Application.Interfaces;
using ${model.configuration?.name}.Domain.Common;
...
function BaseGetbyIdHandler(model) {
    return expandToString `
using AutoMapper;
using ${model.configuration?.name}.Application.DTOs.Common;
using ${model.configuration?.name}.Application.Interfaces;
