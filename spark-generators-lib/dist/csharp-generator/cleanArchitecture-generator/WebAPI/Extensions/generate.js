...
function generateAccountContext(model) {
...
function generateBuilderExtension(model) {
    return expandToString `
...
function generateClaimsPrincipalExtension(model) {
    return expandToString `
...
function generateJwtExtension(model) {
    return expandToString `
using Microsoft.IdentityModel.Tokens;
...
function generateCorsPolicyExtension(model) {
    return expandToString `
﻿namespace ${model.configuration?.name}.WebApi.Extensions
{
