...
import { CompositeGeneratorNode, expandToStringWithNL } from "langium/generate";
...
function generateConfiguration(model, cls, mod, relation_maps) {
...
function generateRelations(cls, relation_maps) {
...
function generateUserConfiguration(model) {
    return expandToStringWithNL `
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
function generateRoleConfiguration(model) {
    return expandToStringWithNL `
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
using ${model.configuration?.name}.Domain.Security.Account.Entities;
