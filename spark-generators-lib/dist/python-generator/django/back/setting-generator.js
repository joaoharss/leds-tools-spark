...
function createManage(softwareName) {
    const lines = [
        `#!/usr/bin/env python`,
...
function createProductionSetting() {
    const lines = [
        `from .base import *`,
        `from decouple import config`,
        `import dj_database_url`,
...
function createBaseSetting(app, solution_name) {
    const lines = [
        `"""`,
        `Django settings`,
        ``,
...
function createURL(softwareName, description, app) {
    const lines = [
...
function createWSGI(softwareName) {
    const lines = [
        `"""`,
...
function createASGI(softwareName) {
    const lines = [
        `"""`,
...
function generateDockerfile(softwareName) {
    const lines = [
